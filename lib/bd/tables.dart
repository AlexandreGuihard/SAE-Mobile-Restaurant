class TablesBd{
  static Future<void> addTables(db) async {
    ...
    db.execute("create table prefererrestaurant(idutilisateur int, idrestaurant int, primary key(idutilisateur, idrestaurant), foreign key (idutilisateur references utilisateur (idutilisateur), foreign key (idrestaurant) references restaurant (idrestaurant))");
    db.execute("create table preferercuisine(idutilisateur int, idcuisine int, primary key(idutilisateur, idcuisine), foreign key (idutilisateur references utilisateur (idutilisateur), foreign key (idcuisine) references cuisine (idcuisine))");
    print("Tables créees");
  }
}